            ...
            <div class="p-4 flex gap-4">
                ...
                <div class="w-full">
                    <h2 class="mb-4 flex items-start justify-between">
                        <a href="{{ route('thread',$thread->id) }}" class="txt-xl font-semibold text-white/90">
                            {{ $thread->title }}
                        </a>
                    ...
                    <p class="flex item-center justify-between w-full text-xs">
